function []=make_Fig5_singlesess_ForGrace(data)

show_points = false;  % <-- toggle individual data points on/off
svg_output=['/Volumes/Colada/Grace/MyPapers/Figs_svg/Fig3/matlab/'];
...
box off;
hold off;
saveas(gcf,[svg_output 'correct_error'],'svg')
...
box off;
hold off;
saveas(gcf,[svg_output 'low_nback'],'svg')
...
saveas(gcf,[svg_output 'high_nback'],'svg')
end